...
const facts = [["4","Economics Categories"],["1,200","Word Maximum"],["Free","Entry"],["14–19","Eligible Ages"],["Worldwide","Eligibility"],["Central Asia","Essay Focus"]];
...
const questions = [
  {category:"Development Economics",status:"Official question",question:"Does labor migration help or hinder Central Asia's long-term economic development?"},
  {category:"Behavioral Economics",status:"Official question",question:"Why do households in Central Asia underutilize subsidized green programs, and is simplifying complex application processes more effective than using behavioral nudges?"},
  {category:"Labor & Public Economics",status:"Official question",question:"Should Central Asian governments subsidize childcare to increase female labor-force participation?"},
  {category:"Political Economics",status:"Official question",question:"Should Central Asian governments phase out energy price subsidies even when doing so risks political instability? Using one Central Asian country, assess whether targeted income support could replace broad energy subsidies without significantly worsening household welfare."}
];
...
const partners = [];
const awards = [["Category Winners","One winner per category may receive official recognition, website recognition, and consideration for confirmed publication or academic opportunities."],["Overall Winner","One Category Winner may additionally receive the title “Overall Winner — Central Asia Economics Prize.”"],["Finalists","The highest-rated essays in each category may receive official recognition and invitations to relevant finalist activities where confirmed."]];
...
const faq = [["Who can enter?","High-school students aged 14–19."],["Do I have to live in Central Asia?","No. Students worldwide may participate, but every essay must directly address the Central Asian context."],["How much does it cost?","Entry is free."],["How long can my essay be?","Maximum 1,200 words. The bibliography or reference list is excluded."],["What language should I write in?","English."],["How many essays can I submit?","One essay per participant."],["Can I answer more than one question?","No. Select one of the four official categories and answer its question."],["Can my name appear on the essay?","No. Essays must be submitted without identifying information to facilitate anonymous review."],["Do I need to discuss every Central Asian country?","No. Participants may focus on one or more countries."],["Can teams submit?","No. Entries are individual only."],["Do I need advanced economics knowledge?","No. Strong reasoning and evidence matter more than advanced mathematics."],["Is econometric analysis required?","No."],["Can I use AI?","Generative AI must not produce substantive ideas, arguments, analysis, essay text, or conclusions on the participant's behalf."],["Which citation style should I use?","Any recognized academic citation style used consistently."],["How are essays judged?","Eligible essays undergo preliminary anonymous review, normally by two reviewers, before the strongest submissions advance to final academic judging."],["Will every participant receive feedback?","No. Individual feedback cannot be guaranteed."],["Will winning essays be published?","CAEP intends to pursue publication opportunities for selected outstanding essays. Any confirmed publication arrangements will be announced separately."]];
...
questions.forEach((item,index) => add("#question-grid", `<article class="question-card reveal"><div class="question-top"><span>Category ${index + 1}</span><small>${item.status}</small></div><h3>${item.category}</h3><blockquote>${item.question}</blockquote></article>`));
