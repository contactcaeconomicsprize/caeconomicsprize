...
const facts = [["183","Submissions"],["34","Countries & Territories"],["59","Essays Advanced to Preliminary Review"],["4","Economics Categories"]];
...
const rules = [
  ...
  {title:"Deadline",content:"The 2026 submission deadline was 24 September 2026 at 23:59 Uzbekistan Time (UTC+5). Late entries are not accepted."},
  {title:"Changes Before Deadline",content:"Participants were permitted to replace their submission before the deadline. Revisions are not accepted afterward."}
];
...
const timeline = [
  {date:"September 24, 2026",title:"Submissions Closed",status:"completed"},
  {date:"September 26 – October 1, 2026",title:"Preliminary Review",status:"current"},
  {date:"From October 2, 2026",title:"Finalist Review",status:"upcoming"},
  {date:"Early October 2026",title:"Results Announcement",status:"upcoming"}
];
const faq = [["Who can enter?","High-school students aged 14–19."],["Do I have to live in Central Asia?","No. The competition is open worldwide, but every essay must directly address the Central Asian context."],["When did submissions close?","Submissions closed on 24 September 2026 at 23:59 Uzbekistan Time (UTC+5)."],["What is the current competition stage?","Preliminary review is currently underway. Following initial screening, 59 essays advanced to this stage."],["How much does it cost?","Entry is free."],["How long can my essay be?","Maximum 1,200 words. The bibliography or reference list is excluded."],["What language should I write in?","English."],["How many essays can I submit?","One essay per participant."],["Can I answer more than one question?","No. Select one of the four official categories and answer its question."],["Can my name appear on the essay?","No. Essays are anonymized for review."],["Do I need to discuss every Central Asian country?","No. Participants may focus on one or more countries, but a Central Asian focus is required."],["Can teams submit?","No. Entries are individual only."],["Do I need advanced economics knowledge?","No. Strong reasoning and evidence matter more than advanced mathematics."],["Is econometric analysis required?","No."],["Can I use AI?","Generative AI must not produce substantive ideas, arguments, analysis, essay text, or conclusions on the participant's behalf."],["Which citation style should I use?","Any recognized academic citation style used consistently."],["How are essays judged?","Essays are anonymized before review. Following initial screening and preliminary review, selected essays advance to finalist review by the final judging panel."],["Will every participant receive feedback?","No. Individual feedback cannot be guaranteed."],["Will winning essays be published?","Outstanding participants may receive publication opportunities where arrangements are confirmed; publication is not guaranteed."]];
...
stages.forEach(item => add("#stages-grid", `<article class="stage ${item.status} reveal"><div class="stage-meta"><span>${item.number}</span><small>${item.status}</small></div><h3>${item.title}</h3><p>${item.text}</p></article>`));
